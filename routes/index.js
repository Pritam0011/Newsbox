...
newsr.get("/", async (req, res) => {
  try {
    var url =
      ...
      "country=in&" +
      "apiKey=6774a7a88fc0411c996360a4d2bea4a8";
...
newsr.post("/search", async (req, res) => {
  ...
  try {
    var url = `http://newsapi.org/v2/everything?q=${search}&apiKey=6774a7a88fc0411c996360a4d2bea4a8`;
...
// // apis
// const API_KEY = "6774a7a88fc0411c996360a4d2bea4a8";
